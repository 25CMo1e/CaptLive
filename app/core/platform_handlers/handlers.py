...
from app.douyin_fetcher.streamcap_adapter import StreamCapDouyinFetcher
...
class DouyinHandler(PlatformHandler):
    ...
    def start_barrage(self, live_id, on_chat=None, on_gift=None, on_member=None, on_like=None, 
                     on_social=None, on_emoji_chat=None, on_room_user_seq=None, on_room_stats=None, 
                     on_control=None, on_error=None):
        self.fetcher = StreamCapDouyinFetcher(
            live_id, 
            on_chat=on_chat, 
            on_gift=on_gift, 
            on_member=on_member, 
            on_like=on_like,
            on_social=on_social,
            on_emoji_chat=on_emoji_chat,
            on_room_user_seq=on_room_user_seq,
            on_room_stats=on_room_stats,
