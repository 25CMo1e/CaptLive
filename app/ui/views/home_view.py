        ...
        for recording_info in recordings_info:
            if recording_info.get("record_format"):
                recording = Recording(
                    ...
                    enabled_timed_recording=recording_info.get("enabled_timed_recording", user_config.get("enable_timed_recording", False)),
                    timed_recording_days=recording_info.get("timed_recording_days", 0),
                    timed_recording_hours=recording_info.get("timed_recording_hours", 0),
                    timed_recording_minutes=recording_info.get("timed_recording_minutes", 0)
                )
            else:
                recording = Recording(
                    rec_id=str(uuid.uuid4()),
                    ...
                    enabled_barrage_recording=recording_info.get("enabled_barrage_recording", user_config.get("enable_barrage_recording", False)),
                    enabled_timed_recording=recording_info.get("enabled_timed_recording", user_config.get("enable_timed_recording", False)),
                    timed_recording_days=recording_info.get("timed_recording_days", user_config.get("timed_recording_days", 0)),
                    timed_recording_hours=recording_info.get("timed_recording_hours", user_config.get("timed_recording_hours", 0)),
                    timed_recording_minutes=recording_info.get("timed_recording_minutes", user_config.get("timed_recording_minutes", 0))
                )
