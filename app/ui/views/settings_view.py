            ...
            [
                ...
                self.create_setting_group(
                    ...
                    [
                        ...
                        self.create_setting_row(
                            self._["enable_barrage_recording"],
                            ft.Switch(
                                value=self.get_config_value("enable_barrage_recording", False),
                                data="enable_barrage_recording",
                                on_change=self.on_change,
                            ),
                        ),
                        self.create_setting_row(
                            self._["enable_timed_recording"],
                            ft.Switch(
                                value=self.get_config_value("enable_timed_recording", False),
                                data="enable_timed_recording",
                                on_change=self.on_change,
                            ),
                        ),
                        self.create_setting_row(
                            self._["timed_recording_duration_minutes"],
                            ft.Row(
                                [
                                    ft.Text(self._["timed_recording_days"], width=60, text_align=ft.TextAlign.CENTER),
                                    ft.TextField(
                                        value=self.get_config_value("timed_recording_days", "0"),
                                        width=80,
                                        data="timed_recording_days",
                                        on_change=self.on_change,
                                        keyboard_type=ft.KeyboardType.NUMBER,
                                    ),
                                    ft.Text(self._["timed_recording_hours"], width=60, text_align=ft.TextAlign.CENTER),
                                    ft.TextField(
                                        value=self.get_config_value("timed_recording_hours", "0"),
                                        width=80,
                                        data="timed_recording_hours",
                                        on_change=self.on_change,
                                        keyboard_type=ft.KeyboardType.NUMBER,
                                    ),
                                    ft.Text(self._["timed_recording_minutes"], width=60, text_align=ft.TextAlign.CENTER),
                                    ft.TextField(
                                        value=self.get_config_value("timed_recording_minutes", "0"),
                                        width=80,
                                        data="timed_recording_minutes",
                                        on_change=self.on_change,
                                        keyboard_type=ft.KeyboardType.NUMBER,
                                    ),
                                ],
