...
class CardDialog(ft.AlertDialog):
    ...
    def get_content(self, recording):
        ...
        barrage_recording = self._["enabled"] if recording.enabled_barrage_recording else self._["disabled"]
        ...
        dialog_content = ft.Column(
            [
                ...
                ft.Text(f"{self._['barrage_recording']}: {barrage_recording}", size=14),
